        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(url('contact/' .$contacts->id)); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <img src="/image/<?php echo e($contacts->image); ?>" width="300px">
                </div>
            </form>
...
<?php echo $__env->make('contacts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\админ\flower-app\resources\views/contacts/edit.blade.php ENDPATH**/ ?>